...
RUN	git clone https://github.com/scala-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/scala-project/scala
...
if [ ! -d sigs ]; then
	git clone https://github.com/scala-project/gitian.sigs.git sigs
	cd sigs
