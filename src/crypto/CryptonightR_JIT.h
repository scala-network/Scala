...
// - Call v4_generate_JIT_code with "buf" pointed to memory allocated on
// previous step
// - Call the generated code instead of "v4_random_math(code, r)", omit the
// "code" parameter
...
int v4_generate_JIT_code(const struct V4_Instruction *code,
                         v4_random_math_JIT_func buf, const size_t buf_size);
